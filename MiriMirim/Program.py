...
class Program:
    def __init__(self, myInfo):
        ...
        self.root_window.resizable(False, False)  # 창 크기 조절 막기
    ...
    def main_program(self):
        ...
        titleLabel = tk.Label(self.root_window, text=(str(self.my.myGrade)+"학년 "+str(self.my.myClass)+"반 시간표"))
        titleLabel.pack()
        for i in range(0, 5):
            ...
            try:
                ...
                for item in data:
                    ...
                    label = tk.Label(self.root_window, text=str(item))
                    label.pack()
                    j += 1
            except Exception as e:
                print(e)
                tk.Label(self.root_window, text=f"API 데이터 로딩 오류: {e}").pack()
